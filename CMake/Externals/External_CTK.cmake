...
if(NOT DEFINED ${CMAKE_PROJECT_NAME}_USE_PYTHONQT)
  set(${CMAKE_PROJECT_NAME}_USE_PYTHONQT 1)
endif()
...
if(NOT DEFINED CTK_DIR AND NOT ${CMAKE_PROJECT_NAME}_USE_SYSTEM_${proj})
  ...
  if(${CMAKE_PROJECT_NAME}_USE_PYTHONQT)
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_ARGS
      ...
      -DCTK_LIB_Scripting/Python/Core_PYTHONQT_WRAP_QTNETWORK:BOOL=${${CMAKE_PROJECT_NAME}_USE_PYTHONQT}
      -DCTK_LIB_Scripting/Python/Core_PYTHONQT_WRAP_QTWEBKIT:BOOL=${${CMAKE_PROJECT_NAME}_USE_PYTHONQT}
      -DCTK_LIB_Scripting/Python/Widgets:BOOL=${${CMAKE_PROJECT_NAME}_USE_PYTHONQT}
      -DCTK_ENABLE_Python_Wrapping:BOOL=${${CMAKE_PROJECT_NAME}_USE_PYTHONQT}
      )
  endif()
